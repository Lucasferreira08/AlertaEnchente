...
//     // Título com ênfase
//     ssd1306_draw_string(display, "!!! ALERTA DE ENCHENTE !!!", 0, 0);
//     ssd1306_line(display, 0, 10, WIDTH-1, 10, 1);
    
//     // Nível de água com alerta visual se acima do limite
//     ssd1306_draw_string(display, "Nivel de agua:", 0, 15);
//     snprintf(buffer, sizeof(buffer), "%d%%", dados->nivel_agua);
//     ssd1306_draw_string(display, buffer, 95, 15);
    
//     // Barra de progresso com destaque se estiver acima do limite
//     ssd1306_rect(display, 0, 25, 100, 10, 1, 0);
//     ssd1306_rect(display, 0, 25, dados->nivel_agua, 10, 1, 1);
//     if (dados->nivel_agua >= NIVEL_AGUA_LIMITE) {
//         // Destaca com um contorno piscante
//         ssd1306_rect(display, 0, 23, 100, 14, 1, 0);
//     }
...
//     ssd1306_draw_string(display, buffer, 95, 40);
    
//     // Barra de progresso com destaque se estiver acima do limite
//     ssd1306_rect(display, 0, 50, 100, 10, 1, 0);
//     ssd1306_rect(display, 0, 50, dados->volume_chuva, 10, 1, 1);
//     if (dados->volume_chuva >= VOLUME_CHUVA_LIMITE) {
//         // Destaca com um contorno piscante
//         ssd1306_rect(display, 0, 48, 100, 14, 1, 0);
//     }
...
//     // Título
//     ssd1306_draw_string(display, "MONITORAMENTO ENCHENTE", 0, 0);
//     ssd1306_line(display, 0, 10, WIDTH-1, 10, 1);
...
//     // Desenha barra de progresso para nível de água
//     ssd1306_rect(display, 0, 25, 100, 10, 1, 0);
//     ssd1306_rect(display, 0, 25, dados->nivel_agua, 10, 1, 1);
...
//     // Desenha barra de progresso para volume de chuva
//     ssd1306_rect(display, 0, 50, 100, 10, 1, 0);
//     ssd1306_rect(display, 0, 50, dados->volume_chuva, 10, 1, 1);
